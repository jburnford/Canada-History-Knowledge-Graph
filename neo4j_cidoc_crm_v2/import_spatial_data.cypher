// Canadian Census CIDOC-CRM Spatial Data Import Script (v2 - Persistent Places)
// Part 1: Node Import (E53, E4, E93, E94, E42)
// Changes: E53_Place uses persistent_place_id, added E42_Identifier for TCP UID provenance
...
// ============================================================
// STEP 2: Import E53_Place nodes (CSD places - PERSISTENT)
// Now uses persistent_place_id instead of raw TCP UIDs
// ============================================================
...
// ============================================================
// STEP 8: Import E42_Identifier nodes (TCP UID provenance)
// ============================================================
LOAD CSV WITH HEADERS FROM 'file:///e42_identifiers.csv' AS row
CALL {
  WITH row
