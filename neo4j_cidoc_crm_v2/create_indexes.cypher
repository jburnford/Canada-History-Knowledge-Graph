// Canadian Census CIDOC-CRM Index Creation (v2 - Persistent Places)
...
CREATE INDEX identifier_id_index FOR (n:E42_Identifier) ON (n.identifier_id);
CREATE INDEX appellation_id_index FOR (n:E41_Appellation) ON (n.appellation_id);
...
// E42 identifier value
CREATE INDEX identifier_value_index FOR (n:E42_Identifier) ON (n.value);
